...
exports.genre_delete_get = function(req, res, next) {
    ...
    async.parallel({
      ...
      {title: 'Delete genre', genre: results.genre, book: results.book})
    })
...
exports.genre_delete_post = function(req, res, next) {
    ...
    async.parallel({
      genre: function(callback){
        Genre.findById(req.body.bodyid).exec(callback)
      },
      book: function(callback){
...
exports.genre_update_post = [
  (req,res,next) => {
    ...
    if(!(req.body.name instanceof Array)){
      ...
      req.body.name = new Array(req.body.name);
    }
    next();
  },
  ...
  (req,res,next) => {
    ...
    if(!errors.isEmpty()){
      ...
      .exec(function(err, results){
        ...
        res.render('genre_form',{title:'Update genre', genres:results})
      })
    }
    else{
